(function () {
  ...
  function renderDefaultQuestions(camp, words) {
    return [
      ...
      ["ARE YOU A MEMBER OF THE ORGANIZATION?", "NO, I WORK FOR GOOD MERITS INC, A PROFESSIONAL FUNDRAISING COMPANY WHICH HAS BEEN CONTRACTED BY " + camp.shortName + "."],
  ...
  function renderScript(camp) {
    ...
    const greeting = isInbound
      ? 'HELLO THANKS FOR CALLING BACK IN <b><span id="first_name">--A--first_name--B--</span> <span id="last_name">--A--last_name--B--</span></b> THIS IS (CALLERS FULL NAME) CALLING FOR <b><span class="highlight-yellow">' + camp.shortName + '.</span></b>'
    ...
    document.title = "NONPAID " + camp.shortName + titleSuffix;
    document.body.innerHTML =
      '<h1>NONPAID ' + camp.shortName + titleSuffix + '</h1>' +
      '<section id="SCRIPTS">' +
      ...
      '<section id="DOESNT_USE_CARD"><h3>DOES NOT USE CARD OVER PHONE / NOT COMFORTABLE USING CARD</h3><p>I COMPLETELY UNDERSTAND YOUR HESITATION (DONOR NAME) BUT YOUR IMMEDIATE SUPPORT WOULD GO A LONG WAY FOR ' + words.supporters + '. THAT IS WHY FOR YOUR SAFETY EVERYTHING IS DONE ON A SECURE LINE AND WE DO NOT TAKE THE SECURITY CODE ON THE BACK OF YOUR CARD SO IT CAN NEVER BE USED AGAIN. ALSO THE CHARGE WOULD SHOW UP AS ' + camp.shortName + ' SO YOU KNOW EXACTLY WHERE YOUR MONEY IS GOING, SO WOULD THAT BE OK FOR YOU JUST THIS ONE TIME?</p><a href="#NONPAID_REBUTTALS">BACK TO REBUTTALS</a></section>' +
      ...
      '<section id="DOES_NOT_HAVE_CARDS"><h3>DOES NOT HAVE CARDS</h3><p>DO YOU HAVE A DEBIT OR BANK CARD YOU CAN USE?<br /><b>IF NO</b> - OK NO PROBLEM, DO YOU STILL HAVE THE PLEDGE KIT FROM ' + camp.shortName + '?<br /><b>IF YES</b> - GREAT, CAN ' + camp.shortName + ' COUNT ON YOU TO SEND BACK YOUR DONATION RIGHT AWAY?<br />GREAT THANK YOU FOR YOUR SUPPORT!</p><a href="#NONPAID_REBUTTALS">BACK TO REBUTTALS</a></section>' +
